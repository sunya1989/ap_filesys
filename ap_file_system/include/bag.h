...
#define SHOW_BAG    struct bag_head *bag_l; \
                    do{bag_l = MALLOC_BAG_HEAD();}while(0);
#define BAG_PUSH(b) do{__bag_push(b, bag_l);}while(0);
#define B_return(r) {__bag_release(bag_l); return r;}
